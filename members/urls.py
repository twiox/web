...
urlpatterns = [
    ...
    path("gruppe/<int:pk>/detail/", views.GroupDetailView.as_view(),name="group_detail"),
    path("gruppe/<int:pk>/liste/", views.RealGroupDetailView.as_view(),name="real_group_detail"),
