...
urlpatterns = [
    ...
    path("veranstaltungen/<int:pk>/orga/", views.EventOrgaView.as_view(),name="event_participants"),
    ...
    path("altersgruppe/<int:pk>", views.AgeGroupDetailView.as_view(),name="agegroup_detail"),
    ...
    path("shop/entferne_item/<int:pk>",views.ShopItemDeleteView.as_view(),name="shopitem_delete"),
