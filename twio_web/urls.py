...
urlpatterns = [
    ...
    path('registriere_trainer/', user_views.register_trainer, name="register_trainer"),
    path('trainer/',user_views.TrainerListView.as_view(), name="trainer_list"),
    path('trainer/<int:pk>/ändern', user_views.TrainerUpdateView.as_view(),name="trainer_update_form"),
    ...
    path('lösche_trainer/', user_views.remove_trainer, name="remove_trainer"),
