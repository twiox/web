...
urlpatterns = [
    ...
    path(
        "liste/<int:pk>/entfernen/",
        views.ChairmanDeleteView.as_view(),
        name="chairman_delete",
    ),
    path(
        "liste/<int:pk>/ändern/",
        views.ChairmanUpdateView.as_view(),
        name="chairman_update",
    ),
    ...
    path(
        "trainer/ändere/<int:pk>",
        trainer_views.TrainerUpdateView.as_view(),
    ...
    path(
        "ajax/kopiere-participant-listen",
        views.get_participants_emails,
        name="get_participants_emails",
    ),
    path(
        "ajax/mitglieder/detail_form/<int:pk>",
        views.member_detail_form,
        name="get_member_detail_form",
    ),
    path(
        "ajax/mitglieder/detail_form/<int:pk>/update",
        views.member_detail_update,
        name="member_detail_form_update",
    ),
]
